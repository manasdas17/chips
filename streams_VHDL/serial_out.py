...
"        end if;",
"        {1} <= STREAM_{0}(0);".format(identifier_a, name),
"      when TX1 =>",
"        if X16CLK_EN_{0} = '1' then".format(identifier),
"          STATE_{0} <= TX2;".format(identifier),
"        end if;",
"        {1} <= STREAM_{0}(1);".format(identifier_a, name),
"      when TX2 =>",
"        if X16CLK_EN_{0} = '1' then".format(identifier),
"          STATE_{0} <= TX3;".format(identifier),
"        end if;",
"        {1} <= STREAM_{0}(2);".format(identifier_a, name),
"      when TX3 =>",
"        if X16CLK_EN_{0} = '1' then".format(identifier),
"          STATE_{0} <= TX4;".format(identifier),
"        end if;",
"        {1} <= STREAM_{0}(3);".format(identifier_a, name),
"      when TX4 =>",
"        if X16CLK_EN_{0} = '1' then".format(identifier),
"          STATE_{0} <= TX5;".format(identifier),
"        end if;",
"        {1} <= STREAM_{0}(4);".format(identifier_a, name),
"      when TX5 =>",
"        if X16CLK_EN_{0} = '1' then".format(identifier),
"          STATE_{0} <= TX6;".format(identifier),
"        end if;",
"        {1} <= STREAM_{0}(5);".format(identifier_a, name),
"      when TX6 =>",
"        if X16CLK_EN_{0} = '1' then".format(identifier),
"          STATE_{0} <= TX7;".format(identifier),
"        end if;",
"        {1} <= STREAM_{0}(6);".format(identifier_a, name),
"      when TX7 =>",
"        if X16CLK_EN_{0} = '1' then".format(identifier),
"          STATE_{0} <= STOP;".format(identifier),
"        end if;",
"        {1} <= STREAM_{0}(7);".format(identifier_a, name),
"      when STOP =>",
"        if X16CLK_EN_{0} = '1' then".format(identifier),
